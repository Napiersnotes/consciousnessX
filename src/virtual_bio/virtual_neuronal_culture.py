...
class VirtualNeuronalCulture:
    ...
    def initialize_network(self):
        ...
        mask = (
            np.random.rand(self.n_neurons, self.n_neurons) < self.config["connection_probability"]
        )
    ...
    def update(self, external_input=None, time_step=None):
        ...
        dV = (
            -(self.membrane_potentials - self.config["resting_potential"]) + self.input_currents
