...
class QuantumVisualizer:
    ...
    def plot_circuit_diagram(
        ...
        for i, (gate_type, qubit, controls) in enumerate(gates):
            ...
            if gate_type == 'H':
                rect = Rectangle((x - 0.4, -qubit - 0.4), 0.8, 0.8, 
                ...
                box = Rectangle((x - 0.4, -qubit - 0.4), 0.8, 0.8, 
    ...
    def plot_decoherence(
        ...
        ax.plot(time_points, t1_times, label='T1 (Relaxation)', 
                linewidth=2, color='blue')
        ax.plot(time_points, t2_times, label='T2 (Dephasing)', 
    ...
    def plot_fidelity_over_time(
        ...
        if target_fidelity is not None:
            ax.axhline(target_fidelity, color='red', linestyle='--', 
    ...
    def plot_error_correction(
        ...
        ax.plot(time_points, physical_errors, label='Physical Error Rate', 
                linewidth=2, color='red', linestyle='--')
        ax.plot(time_points, logical_errors, label='Logical Error Rate', 
